...
non-sensitive, reproducible bugs and focused feature proposals. Include:

- KeyFlow version/build and macOS version;
- Mac/trackpad class without serial numbers;
- exact steps and expected/observed behavior;
- the redacted diagnostics export when useful.

Do not post configuration files, typed text, action values, screenshots
containing private content, signing material, or security vulnerabilities in a
