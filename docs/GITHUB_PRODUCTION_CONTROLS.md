...
1. Protect `main`, require pull requests and a current
   `Build, test, and package` check, require resolved conversations, include
   administrators, require linear history, and forbid force-push/deletion.
   ...
   review.
2. Create a protected `production` environment. Add a reviewer who is
