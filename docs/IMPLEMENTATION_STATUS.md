...
| Data | Schema-18 JSON, legacy migration, atomic writes, stale-revision protection, ten rolling backups, corrupt-primary recovery |
...
| Tests | 79 core and app-model tests covering Codable, migration, recovery, trigger conflicts, 3/4/5-finger lifecycles, tap/click separation, window selection, persistence, services, and orchestration; AddressSanitizer and ThreadSanitizer runs pass locally |
